                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                      ...
                      @else
                        ...
                        <a href="{{ route('signup') }}" class="nav-item nav-link active">Sign Up</a>
                        @endif
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4">Registration Now</h1>
                ...
                <div class="col-lg-5">
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form action="{{ route('signup.stor') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <input type="password" name='passwordCon'  class="form-control p-4" placeholder="Your Password_Conform" required="required" />
                                </div>
                                <!-- <div class="form-group">
